            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Image.asset("assets/intro1.png",fit: BoxFit.fill,),
                ),
              ),
              SizedBox(height: 10,),
              Container(
                child: Text("Phần mềm hỗ trợ quản lý chi tiêu \n cá nhân, gia đình, phòng trọ...",
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text("Đăng nhập", style: TextStyle(fontSize: 18,color: Colors.white, fontWeight: FontWeight.bold),),
                  ),
                ),
              ),
              Text("Hoặc",style: TextStyle(fontSize: 18,), ),
              Row(
                ...
                FlatButton(
                    ...
                    child: Container(
                      height: 50,
                        width: 50,
                        child: Image.asset("assets/icongoogle.png",fit: BoxFit.fill,))
                ),
              ],),
